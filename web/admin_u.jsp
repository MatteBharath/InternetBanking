    ...
    <div class="block_header">
      ...
      <div class="menu">
        <ul>
          ...
          <li><a href="admin_u.jsp" class="active">users</a></li>
             ...
             <p>             </p>
              <table width="349" border="0" align="center">
                ...
                <tr>
                  ...
                  <td><h4><span class="style6"><font size="2" color="white">Balance</span></h4></td>
                </tr>
                <%
  ResultSet rs0=stmt3.executeQuery("select * from amount");
		int s=0;	
                   while(rs0.next())
			{
                          // out.print("****"); 
...
%>
                <tr>
                  ...
                  <td><span class="style7"><font size="2" color="white">
                    <% out.print(rs0.getString("balance"));%>
                  </span></td>
                </tr>
                <%
