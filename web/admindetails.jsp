           ...
           <td><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
             ...
             <table width="900" border="0" align="right">
                <tr>
                  ...
                  <td><h4><span class="style6"><font size="2" color="white">Name</span></h4></td>
                  <td><h4><span class="style6"><font size="2" color="white">Address</span></h4></td>
                  <td><h4><span class="style6"></span></h4></td>
                  <td><h4><span class="style6"><font size="2" color="white">Phone Number</span></h4></td>
				   <td><h4><span class="style6"><font size="2" color="white">Status</span></h4></td>
                </tr>
                <%
  ResultSet rs0=stmt3.executeQuery("select * from user_reg where status='0'");
		int s=0;	
                   while(rs0.next())
			{
                          // out.print("****"); 
...
%>
                <tr>
				  ...
				  <td><span class="style7"><font size="2" color="white">
                    <a href="act.jsp?id=<% out.print(rs0.getString("id"));%>">Activate</a>
                  </span></td>
                </tr>
                <%
